...
<html lang="ja">
	...
	<body>
				...
				<table id="tbl_rep" class="table table-striped">
					<?php
						...
						foreach ($rows_rep as $row_rep){
							...
							echo "\t\t\t\t\t\t\t\t\t\t"."type='submit'\n";
							echo "\t\t\t\t\t\t\t\t\t\tonclick=addSectionRow('".$rep_id."','".$_SESSION["USERNAME"]."');>\n";
							echo "\t\t\t\t\t\t\t\t\t<span>章の追加</span>\n";
							echo "\t\t\t\t\t\t\t\t</button>\n";
							echo "\t\t\t\t\t\t\t\t<button id='btn_updt_sec_".$rep_id."'\n";
							echo "\t\t\t\t\t\t\t\t\t\t"."name='btn_updt_sec_".$rep_id."'\n";
							...
							foreach ($rows_sec as $row_sec){
								...
								echo "\t\t\t\t\t\t\t\t<tr id='".$sec_uuid."' name='".$sec_onm."'>\n";
								...
								// Control menu.
								echo "\t\t\t\t\t\t\t\t\t<td style='vertical-align: middle; width:100px' id='sct_ctr_mv_".$sec_uuid."'>\n";
								echo "\t\t\t\t\t\t\t\t\t\t<div class='btn-group'>\n";
								
								echo "\t\t\t\t\t\t\t\t\t\t<button id='btn_sct_up_".$sec_uuid."'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."name='btn_itm_up'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."class='btn btn-sm btn-primary'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."type='submit'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\tonclick=moveUp('".$tbl_sec_id."','".$sec_uuid."');>\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t<span class='glyphicon glyphicon-chevron-up'></span>\n";
								echo "\t\t\t\t\t\t\t\t\t\t</button>\n";
								
								echo "\t\t\t\t\t\t\t\t\t\t<button id='btn_sct_dwn_".$sec_uuid."'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."name='btn_itm_dwn'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."class='btn btn-sm btn-primary'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."type='submit'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\tonclick=moveDown('".$tbl_sec_id."','".$sec_uuid."');>\n";
								...
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."type='submit'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\tonclick=deleteRow('".$tbl_sec_id."','".$sec_uuid."');>\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t<span>章の削除</span>\n";
								echo "\t\t\t\t\t\t\t\t\t\t</button>\n";
								...
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."class='btn btn-sm btn-primary'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\t"."type='submit'\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t\tonclick=moveToSection('".$sec_uuid."','".$prj_id."','".$rep_id."');>\n";
								echo "\t\t\t\t\t\t\t\t\t\t\t<span>章の編集</span>\n";
								echo "\t\t\t\t\t\t\t\t\t\t</button>\n";
		...
		<script language="JavaScript" type="text/javascript">
			function addSectionRow(rep_id, crt_mem){
				...
				// Create a down button.btn_updt_sec_
				...
				var sct_itm_dll_func = new Function("deleteRow('"+ tbl_id + "','" + row_id + "');");
				...
				var btn_update_id = '<?php echo "btn_updt_sec_".$rep_id; ?>';
			...
			function deleteRow(tbl_id, row_id){
				...
				if (diag_del_con === true) {
					...
					query = "delete_section.php?uuid=" + row_id + "&prj_id=<?php echo $prj_id; ?>";
			...
			function updateSection(prj_id, rep_id, tbl_id){
				...
				query = "update_section.php?prj_id=" + prj_id + "&rep_id=" + rep_id;
				query = query + "&sec_uid=" + sec_uid + "&sec_nam=" + sec_nam;
				query = query + "&sec_cdt=" + sec_cdt + "&sec_mdt=" + sec_mdt;
				query = query + "&sec_mem=" + sec_mem + "&sec_ord=" + sec_ord;
